...
final _searchRecipesWithComplexFiltersJson = '''
{
  "results": [
    {
      "id": 658615,
    ...
    },
    {
      ...
      "image": "https://img.spoonacular.com/recipes/655525-312x231.jpg",
      "imageType": "jpg"
    },
    {
      "id": 637054,
...
final searchedRecipesWithComplexFilters = SpoonacularResultModel.fromJson(
  _searchRecipesWithComplexFiltersJson,
  (result) => RecipeSearchResultModel.fromMap(result),
);
